...
VALUES 
  ('jEdmonds', 'Great service! Everything was perfect.', 001, 1),
  ('sBarnes', 'The issue was resolved quickly and efficiently.', 002, 2),
  ('lMoss', 'Had some initial problems, but the support team was helpful.', 003, 3),
  ('uWatts', 'Excellent customer service. Will recommend to others.', 004, 4),
  ('cSampson', 'I had a great experience with the support team.', 005, 5);